...
export default function ShezanPortfolio() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-800 mb-6">Shezan's Portfolio</h1>
        ...
        <div className="bg-gradient-to-r from-pink-400 via-purple-400 to-indigo-400 rounded-2xl p-12 mb-12 text-white text-center">
          <h2 className="text-4xl font-bold mb-4">Hello, I'm Shezan</h2>
        ...
        <div className="bg-gradient-to-br from-pink-400 to-purple-500 rounded-2xl p-8 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <p className="font-medium">shezan@example.com</p>
            </div>
            <div>
              <div className="text-4xl mb-2">📱</div>
